 ...
 *
 * @method \Model\AclGroup[] get() public static function get(array $columns = array()) returns an array of models AclGroup
 * @method null|\Model\AclGroup first() public static function first(array $columns = array()) returns model AclGroup
 *
 ...
 * @property-read \Model\User[] users A collection of foreign models related via many to many relation 
 * @property-read \Model\AclRole[] aclRoles A collection of foreign models related via many to many relation 
 */
abstract class AclGroup extends \Subscribo\ModelBase\AbstractModel {
    ...
    {
        return $this->belongsToMany('\\Model\\User', 'acl_group_user', 'acl_group_id', 'user_id', 'users');
    }
    ...
    {
        return $this->belongsToMany('\\Model\\AclRole', 'acl_group_acl_role', 'acl_group_id', 'acl_role_id', 'aclRoles');
    }

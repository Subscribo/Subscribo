 ...
 *
 * Modified.
 * Private method _value has been taken from Fuel class (public method value)
 * Private method _call_fuel_func_array has been taken from Fuel Base (function call_fuel_func_array)
 *
 * @todo Some modified parts are not tested at all. Some modified parts are not fully tested.
 *
 * @package     Fuel
 * @subpackage  Core
 */
class Arr
{
	 ...
	 * not exist.
     *
     * Modified. (using self::_value() instead of \Fuel::value())
     ...
     *
     * Modified. (using self::_call_fuel_func_array() instead of call_fuel_func_array())
     * @todo Not tested.
	 *
	...
	public static function multisort($array, $conditions, $ignore_case = false)
	{
		...
		self::_call_fuel_func_array('array_multisort', $args);
		return $array;
	}
     ...
     * value.
     *
     * Taken from Fuel Core class of the framework
     * @todo Not fully tested.
     *
     * @param   mixed  $var  The value to get
     * @return  mixed
     */
    private static function _value($var)
    {
     ...
     * @return mixed
     */
    private static function _call_fuel_func_array($callback , array $args)
    {

...
Important note:
Only some class(es) has been taken from fuel project into this project and possibly modified.

- 09.12.2014 by Slavo - moved to package Subscribo/SchemaBuilder (under src/lib subdirectory), changed directory structure

- Core:Arr  - 23.10.2014 by Slavo, renamed file and directory names in order to conform with psr-4, some functionality have been taken from other parts of network and the class has been modified (to use it)
## v1.7.2

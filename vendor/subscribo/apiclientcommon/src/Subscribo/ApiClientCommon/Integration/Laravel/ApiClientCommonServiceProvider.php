...
class ApiClientCommonServiceProvider extends ServiceProvider
{
    ...
    public function registerRoutes(Router $router, $uri = 'question')
    {
        ...
        $router->get($uri, 'Subscribo\\ApiClientCommon\\Controllers\\QuestionaryController@getQuestionary');
        $router->post($uri, 'Subscribo\\ApiClientCommon\\Controllers\\QuestionaryController@postQuestionary');
